...
//   // Get the projection matrix, you should set inverted_y_axis to true, if you
//   // are using vulkan backend.
//   glm::mat4 GetProjection(float width, float height,
//                           bool inverted_y_axis = true) const;
...
//   Vec3 model_rotate_axis_{0.0f, 0.0f, 1.0f};
//   float model_rotate_angle_{0.0f};

//   Vec3 position_{3.0f, 0.0f, 1.0f};
//   Vec3 front_{-3.0f, 0.0f, -1.0f};
