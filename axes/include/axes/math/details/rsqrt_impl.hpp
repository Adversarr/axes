...
#  include <immintrin.h>
#  define AXES_RSQRT32(x) _mm_cvtss_f32(_mm_rsqrt_ss(_mm_set_ss((x))))
#endif

#if defined(__arm64__)
#  include <arm_neon.h>
#  define AXES_RSQRT32(x) vrsqrtes_f32((x))
#  define AXES_RSQRT64(x) vrsqrted_f64((x))
#  define AXES_SQRT64(x) vsqrt_f64((x))
#endif
