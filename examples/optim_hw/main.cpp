...
int main(int argc, char** argv) {
  ...
  if (!absl::GetFlag(FLAGS_fista)) {
    optimizer = std::make_unique<Optimizer_GradientDescent>();
    Optimizer_GradientDescent* gd = dynamic_cast<Optimizer_GradientDescent*>(optimizer.get());
    ...
    optimizer = std::make_unique<Optimizer_Fista>();
    Optimizer_Fista* fista = dynamic_cast<Optimizer_Fista*>(optimizer.get());
