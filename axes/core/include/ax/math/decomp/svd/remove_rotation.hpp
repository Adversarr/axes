...
AX_HOST_DEVICE AX_FORCE_INLINE bool svd_remove_rotation(SvdResultImpl<3, Scalar> & svd) {
...
template<typename Scalar>
AX_HOST_DEVICE AX_FORCE_INLINE bool svd_remove_rotation(SvdResultImpl<2, Scalar> & svd) {
