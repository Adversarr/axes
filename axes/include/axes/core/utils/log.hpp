...
#include "axes/core/utils/common.hpp" // IWYU pragma: export
...
#define AXES_DEBUG(...) AXES_LOG(spdlog::level::level_enum::debug, __VA_ARGS__)
#define AXES_TRACE(...) AXES_LOG(spdlog::level::level_enum::trace, __VA_ARGS__)
...
#else
#define AXES_DEBUG_CHECK(condition, ...) axes::utils::do_nothing(__VA_ARGS__);
#endif
#endif
#ifndef NDEBUG
#define INSPECT(val)                                                           \
